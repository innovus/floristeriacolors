...
@section('content')
<section class="puntosFloristeria">
    <div class="container">
        <div class="row text-center puntosRedimir2">
            
          <div class="col-md-6 col-md-offset-3">
           <h4><strong>Tu eliges</strong> como <strong>redimir</strong> tus <strong>puntos</strong></h4>
          </div>
          <div class="col-md-10 col-md-offset-1 puntosRedimir-titulo2">
     ...
     <div class="row">
         <div class="col-md-6 col-md-offset-3 info-puntosRedimir2">
             <p>
